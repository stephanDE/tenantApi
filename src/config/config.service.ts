...
export class ConfigService {
  ...
  constructor() {
    ...
    auth.clientSecret =
      process.env.AUTH_CLIENT_SECRET || '7847ddd2-9707-46ed-bec5-75014c094a76';

    auth.resource = process.env.AUTH_RESOURCE || 'tenant-service';
    auth.publicKey =
    ...
    const database = process.env.MONGO_DATABASE || 'tenant';
